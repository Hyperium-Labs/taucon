I no longer use Unity due to their runtime fee nonsense, so this project will never be updated. Unity has recently dropped their runtime fee and walked back other changes however if you are interested; https://unity.com/blog/unity-is-canceling-the-runtime-fee
